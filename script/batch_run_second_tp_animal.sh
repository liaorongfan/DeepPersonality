...
python run_exp.py -c config/second_stage/spectrum_on_pred_TP/animal/06_interpre_cnn_spectrum.yaml
python run_exp.py -c config/second_stage/spectrum_on_pred_TP/animal/08_senet_spectrum.yaml
python run_exp.py -c config/second_stage/spectrum_on_pred_TP/animal/09_hrnet_spectrum.yaml
python run_exp.py -c config/second_stage/spectrum_on_pred_TP/animal/10_swin_transformer_spectrum.yaml