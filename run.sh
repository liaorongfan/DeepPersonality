...
# python script/run_exp.py -c config/true_personality/single_trait/O/02_hrnet_face.yaml
# python script/run_exp.py -c config/true_personality/single_trait/A/02_hrnet_face.yaml
# python script/run_exp.py -c config/true_personality/single_trait/C/02_hrnet_face.yaml
# python script/run_exp.py -c config/true_personality/single_trait/E/02_hrnet_face.yaml
# python script/run_exp.py -c config/true_personality/single_trait/N/02_hrnet_face.yaml
...
# python script/run_exp.py -c config/true_personality/single_trait/O/03_aud_crnet.yaml
# python script/run_exp.py -c config/true_personality/single_trait/C/03_aud_crnet.yaml
