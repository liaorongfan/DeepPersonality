...
if __name__ == "__main__":
    ...
    feature_extract(
        cfg_file="config/impression/sequence_prediction_extract/07_vat_face.yaml",
        model_weight="results/checkpoint_267_vat_16f_acc_9118.pkl",
        data_loader=setup_dataloader,
        output_dir="datasets/second_stage/vat",
    )
