...
class DenseNet(torch.nn.Module):
    def __init__(
        self,layer_num=(6,12,24,16), growth_rate=32,init_features=64,
        in_channels=1,
...
def get_1d_densenet_model(cfg):
    
    model = DenseNet(layer_num=(6,12,24,16),growth_rate=32,in_channels=39,classes=5)
